...
public class GetAccumulators {
    ...
    public GetAccumulators(XmlBuilder xmlBuilder, AirTransport airTransport, XmlParser xmlParser) {
    ...
    public AirResponse execute(Map<String, Object> params) {
        ...
        try {
            String xml = xmlBuilder.buildRequest("GetAccumulators", params);
            String rawXml = airTransport.send(xml, "GetAccumulators");
