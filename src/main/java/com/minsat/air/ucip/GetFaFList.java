...
public class GetFaFList {
    ...
    public GetFaFList(XmlBuilder xmlBuilder, AirTransport airTransport, XmlParser xmlParser) {
    ...
    public AirResponse execute(Map<String, Object> params) {
        ...
        try {
            String xml = xmlBuilder.buildRequest("GetFaFList", params);
            String rawXml = airTransport.send(xml, "GetFaFList");
